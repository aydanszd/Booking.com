...
export default function CarDeleteModal({ car, onClose, onSuccess }: CarDeleteModalProps) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            toast.success(`${car.brand} ${car.model} silindi`);
            onSuccess();
        } catch (e: any) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="font-bold text-gray-800 text-base mb-1">Maşını Sil</h2>
