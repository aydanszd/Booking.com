        ...
        <div className="pb-10">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1">
                    <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-1.5 mt-2 text-sm text-gray-500">
                                ...
                                <span className="text-blue-600 font-bold cursor-pointer hover:underline text-xs ml-2 uppercase tracking-tighter">— {t("showOnMap")}</span>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-4 grid-rows-2 gap-3 h-112.5 mb-8 rounded-3xl overflow-hidden shadow-2xl shadow-gray-200">
                        ...
                        {slides.length > 4 && (
                            <button onClick={() => openLightbox(4)} className="col-span-1 row-span-1 relative group overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-black/50 group-hover:bg-black/70 transition-all flex flex-col items-center justify-center text-white">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest">{t("photos")}</span>
                                </div>
                            </button>
                        )}
                    </div>
                ...
                <div className="lg:w-80 shrink-0">
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 sticky top-24">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                <p className="text-xl font-black text-gray-900 italic">{t("excellent")}</p>
                                <p className="text-xs font-bold text-gray-400 uppercase tracking-tighter">1,245 {t("guestReviews")}</p>
                            </div>
                        ...
                        <div className="space-y-4 pt-4 border-t border-gray-100">
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-bold text-gray-500 uppercase tracking-tighter">{t("location")}</span>
                                <span className="text-sm font-black text-blue-600">9.5</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-bold text-gray-500 uppercase tracking-tighter">{t("cleanliness")}</span>
