                        ...
                        <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={() => setViewMode("list")}
                                    className={`border rounded-lg px-3 py-1.5 text-xs flex items-center gap-1.5 transition-colors ${viewMode === "list" ? "border-[#006ce4] text-[#006ce4] bg-blue-50" : "border-gray-300 bg-white text-gray-700 hover:border-gray-400"}`}>
                                    <LayoutList size={13} /> List
                                </button>
                                <button onClick={() => setViewMode("grid")}
                                    className={`border rounded-lg px-3 py-1.5 text-xs flex items-center gap-1.5 transition-colors ${viewMode === "grid" ? "border-[#006ce4] text-[#006ce4] bg-blue-50" : "border-gray-300 bg-white text-gray-700 hover:border-gray-400"}`}>
