...
const CATEGORIES: Category[] = [
    {
        ...
        destinations: [
            ...
            {
                image: "https://q-xx.bstatic.com/xdata/images/city/500x600/691618.jpg?k=6e6bce1099b3b8297c14cbe6e4cf33d1a797ca3cdc9c4a3efce00a862d15a9d8&o=",
                city: "Batumi",
                flag: "🇬🇪",
            },
            {
        ...
        <section className="py-10 px-6 max-w-6xl mx-auto font-sans -mt-10 ">
            <div className="mb-5">
                <h2 className="text-2xl font-bold text-gray-900">
                    Trips similar to {baseCity}
                </h2>
                <p className="text-sm text-gray-500 mt-1">
                    More destinations you might like for your travel plans
                </p>
            </div>
...
function DestCard({ dest, tall = false }: { dest: Destination; tall?: boolean }) {
    return (
        <div
            className={`relative overflow-hidden rounded-xl cursor-pointer group ${tall ? "h-68" : "h-68"
                }`}
        >
            <img
                src={dest.image}
            ...
            />
            <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/10 to-transparent" />            <div className="absolute bottom-3 left-3">
