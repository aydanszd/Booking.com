...
const DEALS: Deal[] = [
    ...
    },
    {
        ...
        name: "Azcot Hotel - Nizami Street",
        location: "Baku, Azerbaijan",
        score: 7.5,
        scoreLabel: "Good",
        reviewCount: 191,
        badge: null,
        dealTag: "Early 2026 Deal",
        originalPrice: 59,
        discountedPrice: 50,
        nights: 2,
    },
    ...
    },
    {
        ...
        name: "Dastan Boutique Hotel Baku",
        location: "Baku, Azerbaijan",
        score: 9.5,
        ...
        deal.score >= 9
            ...
            : deal.score >= 8
                ...
                : deal.score >= 7
                    ...
                    : "bg-gray-400";
    const dealTagColor =
        deal.dealTag === "Limited-time Deal" ? "bg-green-600" : "bg-green-500";
    return (
        <div className="shrink-0 w-64  bg-white rounded-xl border border-gray-200 overflow-hidden shadow-lg transition-shadow duration-300 cursor-pointer group flex flex-col">
            <div className="relative h-52 shrink-0 overflow-hidden ">
                ...
                <button
                    ...
                    className="absolute top-3 right-3 w-9 h-9 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow hover:scale-110 transition-transform"
                >
                ...
                <div className="h-9 mb-2 flex items-center gap-2">
                    <div className="flex items-center gap-1.5 shrink-0">
                        ...
                        <div className="leading-tight">
                            <p className="text-xs font-semibold text-gray-800">{deal.scoreLabel}</p>
                            <p className="text-[10px] text-gray-400">{deal.reviewCount} reviews</p>
                        </div>
                    </div>
...
export default function DealsForWeekend({
    dateRange = "6 March - 8 March",
}: {
    dateRange?: string;
}) {
    ...
    return (
        <section className="py-10 px-6 max-w-6xl mx-auto font-sans ">
            <div className="mb-6 -mt-5">
                ...
                <p className="text-sm text-gray-500 mt-1">Save on stays for {dateRange}</p>
            </div>
